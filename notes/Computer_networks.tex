...
\usepackage[
	hidelinks, %no box around the reference
	colorlinks=true, %change color of number
]{hyperref} % active ref
...
\input{Chapters/NetworkC}
\input{Chapters/Gateway}
\input{Chapters/Layer2}
\input{Chapters/Layer3}
\input{Chapters/ICMP}
\input{Chapters/Layer4}
\input{Chapters/HTTP}
\input{Chapters/Resolution}
\appendix
\input{Chapters/Shell}
\input{Chapters/Vim}
\input{Chapters/GDB}
\input{Chapters/Code}
